...
import 'package:flutter_json_serializable/models/open_weather/constants.dart';
import 'package:flutter_json_serializable/models/old_flat_weather.dart';

class FlatWeatherScreen extends StatelessWidget {
  Future<OldFlatWeather> getWeahter() async {
    try {
      const String url =
