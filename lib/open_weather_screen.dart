...
import 'package:flutter_json_serializable/models/constants.dart';
import 'package:flutter_json_serializable/models/open_weather/open_weather.dart';

class OpenWeatherScreen extends StatelessWidget {
  Future<OpenWeather> getWeahter() async {
    try {
      const String url =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('JsonSerializable Weahter'),
        ),
        body: FutureBuilder(
          future: getWeahter(),
